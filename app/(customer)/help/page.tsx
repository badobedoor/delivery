...
const faqs = [
  {
    id: 1,
    q: "كيف أتابع طلبي؟",
    a: "بعد تأكيد طلبك، هتلاقي تفاصيله في صفحة 'طلباتي'. فور استلام المندوب للطلب، هيتصل بيك على رقم هاتفك — لازم ترد على الاتصال عشان يقدر يوصلك.",
  },
  {
    id: 2,
    q: "كيف ألغي طلبي؟",
    a: "يمكنك التواصل معنا خلال دقائق من تقديم الطلب قبل إرساله للمطعم.",
  },
  {
    id: 3,
    q: "ما هي مناطق التوصيل؟",
    a: "نوصل لجميع المناطق المتاحة عند اختيار عنوانك. إذا لم تظهر منطقتك، فهي غير متاحة حالياً.",
  },
  {
    id: 4,
    q: "هل أقدر أتواصل مع المندوب مباشرة؟",
    a: "لا يمكن التواصل مع المندوب مباشرة. جميع الطلبات والتواصل يكون من خلال التطبيق فقط للحفاظ على حقوقك وحقوق المندوب.",
  },
  {
    id: 5,
    q: "ماذا يحدث لو رفضت استلام الطلب؟",
    a: "رفض استلام الطلب بدون سبب وجيه، أو عدم التواجد في العنوان المحدد، أو عدم الرد على اتصال المندوب — قد يؤدي إلى تحمّلك تكاليف التوصيل أو حظر حسابك من الطلب مستقبلاً. يُرجى التأكد من صحة عنوانك والاستعداد لاستلام طلبك.",
  },
];
